...
print("haberman")
print("naive bayes")
test = k_cross_validation(X_haberman_cont, y_haberman, "nb", 1, X_haberman_cat)
print(test)
print("Logistic regression")
testlog = k_cross_validation(X_haberman, y_haberman, "log", 0)
print(testlog)

print("Adult")
print("Mixed naive bayes")
test = k_cross_validation(X_adult_cont, y_adult, "nb", 1, X_adult_cat)
print(test)
print("Logistic regression")
testlog = k_cross_validation(X_adult, y_adult, "log", 0)
print(testlog)

print("Ionosphere")
print("naive bayes")
test = k_cross_validation(X_ionosphere, y_ionosphere, "nb", 0)
print(test)
print("Logistic regression")
